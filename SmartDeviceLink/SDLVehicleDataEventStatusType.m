//  SDLVehicleDataEventStatusType.m
//

#import "SDLVehicleDataEventStatusType.h"
#import "SDLNames.h"

@implementation SDLVehicleDataEventStatusType
...
- (void)setValue:(SDLVehicleDataEventStatus *)value {
    if (value != nil) {
...
- (SDLVehicleDataEventStatus *)value {
